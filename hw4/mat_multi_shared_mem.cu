...
int main(int argc, char ** argv) {
    ...
    funcCheck(cudaMallocManaged((void **)&deviceA, sizeof(float)*numARows*numAColumns));
    funcCheck(cudaMallocManaged((void **)&deviceB, sizeof(float)*numBRows*numBColumns));
    funcCheck(cudaMallocManaged((void **)&deviceC, sizeof(float)*numCRows*numCColumns));
    ...
    printf("calculate mat mul using : %d\n", endTime-startTime);
